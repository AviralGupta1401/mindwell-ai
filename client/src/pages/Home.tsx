      ...
      <header className="relative z-10 border-b border-zinc-800">
        <div className="max-w-6xl mx-auto px-6 py-5 flex justify-between items-center">
          ...
          <nav className="flex items-center gap-4 sm:gap-8">
            <Link to="/sign-in" className="text-zinc-400 hover:text-green-500 transition-colors font-medium">
              Sign In
            </Link>
            <Link to="/sign-up" className="px-5 py-2.5 bg-green-500 text-black font-semibold rounded-xl hover:bg-green-400 transition-colors">
              Get Started
            </Link>
          </nav>
        </div>
